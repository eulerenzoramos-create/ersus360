...
function AbaLaboratorio({ exames }: { exames: any[] | undefined }) {
  if (!exames) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
...
function AbaImagem({ modalidades }: { modalidades: any[] | undefined }) {
  if (!modalidades) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
...
function AbaCriticos({ criticos }: { criticos: any[] | undefined }) {
  if (!criticos) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {criticos.map(c => {
