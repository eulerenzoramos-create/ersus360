...
function AbaEquipamentos({ equips }: { equips: any[] | undefined }) {
  ...
  if (!equips) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
...
function AbaOrdens({ ordens }: { ordens: any[] | undefined }) {
  if (!ordens) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
