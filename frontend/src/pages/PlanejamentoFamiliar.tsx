...
function AbaMetodos({ metodos }: { metodos: any[] | undefined }) {
  if (!metodos) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
...
function AbaFaixaEtaria({ faixas }: { faixas: any[] | undefined }) {
  if (!faixas) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 10, padding: 18 }}>
