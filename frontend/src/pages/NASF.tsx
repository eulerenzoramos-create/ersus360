...
function AbaEquipe({ equipe }: { equipe: any[] | undefined }) {
  if (!equipe) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
      {equipe.map(p => {
...
function AbaPrioridades({ prioridades }: { prioridades: any[] | undefined }) {
  if (!prioridades) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
