...
function AbaCriancas({ criancas }: { criancas: any[] | undefined }) {
  ...
  if (!criancas) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
...
function AbaBolsaFamilia({ bf }: { bf: any[] | undefined }) {
  if (!bf) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
