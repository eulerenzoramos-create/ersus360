...
function AbaCriancas({ criancas }: { criancas: any[] | undefined }) {
  ...
  if (!criancas) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
...
function AbaIndicadores({ indicadores }: { indicadores: any[] | undefined }) {
  if (!indicadores) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
...
function AbaBolsaFamilia({ bf }: { bf: any[] | undefined }) {
  if (!bf) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
