...
function AbaTipos({ tipos }: { tipos: any[] | undefined }) {
  if (!tipos) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
...
function AbaReabilitacao({ reab }: { reab: any[] | undefined }) {
  if (!reab) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
      {reab.map(s => {
