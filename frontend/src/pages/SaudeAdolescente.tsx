...
function AbaGravidez({ historico }: { historico: any[] | undefined }) {
  if (!historico) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
...
function AbaDst({ casos }: { casos: any[] | undefined }) {
  if (!casos) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
