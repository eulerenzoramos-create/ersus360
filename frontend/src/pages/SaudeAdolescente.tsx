...
function AbaGravidez({ historico }: { historico: any[] | undefined }) {
  if (!historico) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
...
function AbaDst({ casos }: { casos: any[] | undefined }) {
  if (!casos) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
