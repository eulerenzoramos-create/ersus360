...
function AbaAntibioticos({ atbs }: { atbs: any[] | undefined }) {
  if (!atbs) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
...
function AbaBundles({ bundles }: { bundles: any[] | undefined }) {
  if (!bundles) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
