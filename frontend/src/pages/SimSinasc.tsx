...
function AbaObitos({ obitos }: { obitos: any[] | undefined }) {
  if (!obitos) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
...
function AbaNascidosVivos({ nvs }: { nvs: any[] | undefined }) {
  if (!nvs) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
