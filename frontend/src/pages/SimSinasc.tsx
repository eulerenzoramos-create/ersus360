...
function AbaObitos({ obitos }: { obitos: any[] | undefined }) {
  if (!obitos) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
...
function AbaNascidosVivos({ nvs }: { nvs: any[] | undefined }) {
  if (!nvs) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
