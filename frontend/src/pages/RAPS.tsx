...
function AbaCAPS({ caps }: { caps: any }) {
  if (!caps) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
...
function AbaUsuarios({ usuarios }: { usuarios: any[] | undefined }) {
  ...
  if (!usuarios) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
...
function AbaGrupos({ grupos }: { grupos: any[] | undefined }) {
  if (!grupos) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
...
function AbaLeitos({ leitos }: { leitos: any[] | undefined }) {
  if (!leitos) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
