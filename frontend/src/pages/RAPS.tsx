...
function AbaCAPS({ caps }: { caps: any }) {
  if (!caps) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
...
function AbaUsuarios({ usuarios }: { usuarios: any[] | undefined }) {
  ...
  if (!usuarios) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
...
function AbaGrupos({ grupos }: { grupos: any[] | undefined }) {
  if (!grupos) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
...
function AbaLeitos({ leitos }: { leitos: any[] | undefined }) {
  if (!leitos) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
