...
function AbaIndicadores({ indicadores }: { indicadores: any[] | undefined }) {
  if (!indicadores) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
...
function AbaGestantes({ gestantes }: { gestantes: any[] | undefined }) {
  ...
  if (!gestantes) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
...
function AbaPuerperas({ puerperas }: { puerperas: any[] | undefined }) {
  if (!puerperas) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
