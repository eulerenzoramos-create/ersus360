...
function AbaOcorrencias({ ocorr }: { ocorr: any[] | undefined }) {
  if (!ocorr) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
...
function AbaVeiculos({ veics }: { veics: any[] | undefined }) {
  if (!veics) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
      {veics.map(v => {
