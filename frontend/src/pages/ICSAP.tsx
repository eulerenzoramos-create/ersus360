...
function AbaCausas({ causas }: { causas: any[] | undefined }) {
  if (!causas) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
...
function AbaPorESF({ esfs }: { esfs: any[] | undefined }) {
  if (!esfs) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
...
function AbaAcoes({ acoes }: { acoes: any[] | undefined }) {
  if (!acoes) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
