...
function AbaEstabelecimentos({ estabs }: { estabs: any[] | undefined }) {
  ...
  if (!estabs) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
...
function AbaAutos({ autos }: { autos: any[] | undefined }) {
  if (!autos) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
