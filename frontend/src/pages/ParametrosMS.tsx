      ...
      {pData.componente_qualidade && (
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:12, marginBottom:16 }}>
          {[["C","C — eSF/eAP","#1565c0"], ["B","B — ESB","#7b1fa2"], ["M","M — eMulti","#1b5e20"]].map(([gk, label, cor]) => {
            ...
            if (!g) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  ...
  const abaQualidade = !qualData
    ...
    <div>
      ...
      {["C", "B", "M"].map(gk => {
        ...
        if (!grp) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
