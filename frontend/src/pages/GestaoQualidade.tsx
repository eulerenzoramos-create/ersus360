...
function AbaIndicadoresQ({ indsQ }: { indsQ: any[] | undefined }) {
  if (!indsQ) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
...
function AbaAuditorias({ auds }: { auds: any[] | undefined }) {
  if (!auds) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
...
function AbaNCs({ ncs }: { ncs: any[] | undefined }) {
  if (!ncs) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
