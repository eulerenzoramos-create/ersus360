...
function AbaReunioes({ reunioes }: { reunioes: any[] | undefined }) {
  if (!reunioes) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
...
function AbaConselheiros({ conselheiros }: { conselheiros: any[] | undefined }) {
  if (!conselheiros) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
...
function AbaDeliberacoes({ deliberacoes }: { deliberacoes: any[] | undefined }) {
  ...
  if (!deliberacoes) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
