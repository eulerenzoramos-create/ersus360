...
function AbaAcidentes({ acidentes }: { acidentes: any[] | undefined }) {
  if (!acidentes) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
      {acidentes.map(a => {
...
function AbaRaiva({ raiva }: { raiva: any | undefined }) {
  if (!raiva) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
