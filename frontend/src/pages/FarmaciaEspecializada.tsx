...
function AbaMedicamentos({ meds }: { meds: any[] | undefined }) {
  if (!meds) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
...
function AbaJudicializacao({ juds }: { juds: any[] | undefined }) {
  if (!juds) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
...
function AbaRenovacoes({ renovacoes }: { renovacoes: any[] | undefined }) {
  if (!renovacoes) return <NaoDisponivelBanner nota="Dados nao disponiveis — integracao pendente de configuracao no Railway." />;
  return (
    <div>
