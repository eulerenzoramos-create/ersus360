...
function AbaMedicamentos({ meds }: { meds: any[] | undefined }) {
  if (!meds) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
...
function AbaJudicializacao({ juds }: { juds: any[] | undefined }) {
  if (!juds) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
...
function AbaRenovacoes({ renovacoes }: { renovacoes: any[] | undefined }) {
  if (!renovacoes) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
