...
function AbaVeiculos({ veiculos }: { veiculos: any[] | undefined }) {
  if (!veiculos) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
      {veiculos.map(v => {
...
function AbaManutencoes({ mans }: { mans: any[] | undefined }) {
  if (!mans) return <NaoDisponivelBanner nota="Dados n�o dispon�veis no momento. Integra��o pendente de configura��o no Railway." />;
  return (
    <div>
      {mans.map(m => {
