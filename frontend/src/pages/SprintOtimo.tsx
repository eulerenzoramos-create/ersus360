...
export default function SprintOtimo() {
  ...
  return (
    <div style={{ padding: "0 0 60px 0", fontFamily: "Inter, system-ui, sans-serif", background: "#f1f5f9", minHeight: "100vh", color: "#0f172a" }}>
      ...
      {/* ── Header ── */}
      <div style={{ background: "linear-gradient(180deg, #0d1a35 0%, #09121f 100%)", borderBottom: "1px solid rgba(0,0,0,0.08)", padding: "16px 28px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
            ...
            {editandoMunicipio ? (
              <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                <input
                  ...
                  style={{ background: "#f8fafc", border: "1px solid #3b82f6", borderRadius: 8, color: "#0f172a", padding: "6px 12px", fontSize: 13, width: 160, outline: "none" }}
                />
                <select value={municipioUF} onChange={e => setMunicipioUF(e.target.value)}
                  style={{ background: "#f8fafc", border: "1px solid #3b82f6", borderRadius: 8, color: "#0f172a", padding: "6px 10px", fontSize: 13, outline: "none" }}>
                ...
                <input
                  ...
                  placeholder="IBGE"
                  style={{ background: "#f8fafc", border: "1px solid #3b82f6", borderRadius: 8, color: "#0f172a", padding: "6px 12px", fontSize: 13, width: 90, outline: "none" }}
                />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            {/* Seletor de período */}
            <div style={{ display: "flex", gap: 4, background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 10, padding: 4 }}>
              {PERIODOS.map(p => (
                <button key={p.key} onClick={() => setPeriodo(p.key as any)}
                  style={{
                    ...
                    color: periodo === p.key ? "#fff" : "#93c5fd",
      ...
      <div style={{ display: "flex", gap: 6, padding: "12px 28px", background: "#ffffff", borderBottom: "1px solid #e2e8f0", flexWrap: "wrap" }}>
        {([
          ...
          <button key={t.key} onClick={() => setAba(t.key)} style={{
            ...
            border: aba === t.key ? "1px solid rgba(37,99,235,0.4)" : "1px solid #e2e8f0",
            borderRadius: 8,
            background: aba === t.key ? "linear-gradient(135deg, #2563eb, #1d4ed8)" : "#f8fafc",
            color: aba === t.key ? "#ffffff" : "#475569",
            cursor: "pointer", whiteSpace: "nowrap", display: "flex", gap: 6, alignItems: "center",
            transition: "all 0.15s",
            boxShadow: aba === t.key ? "0 2px 8px rgba(37,99,235,0.25)" : "none",
          }}>
      ...
      <div style={{ padding: "24px 28px" }}>
        ...
        {aba === "cvat" && (() => {
          ...
          return (
            <div>
              {/* Header CVAT */}
              <div style={{ background: "#f8fafc", border: "1px solid #1e3a5f", borderRadius: 10, padding: "14px 18px", marginBottom: 18 }}>
        ...
        {aba === "diagnostico" && (() => {
          ...
          return (
            <div>
              ...
              {/* Observação técnica */}
              <div style={{ background: "#f8fafc", borderRadius: 10, padding: 16, border: "1px solid #1e3a5f", marginBottom: 14 }}>
                ...
                <div>
                  <div style={{ background: "linear-gradient(180deg, #ffffff 0%, #f8fafc 100%)", borderRadius: 12, boxShadow: "0 2px 12px rgba(0,0,0,0.3)", padding: 20, marginBottom: 16 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                      <div>
                        ...
                        {diag && (
                          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 8 }}>
                            <span style={{ background: "#f8fafc", border: "1px solid rgba(0,0,0,0.08)", color: "#475569", fontSize: 11, padding: "2px 8px", borderRadius: 6, fontFamily: "monospace" }}>
                              🏥 {diag.ubs}
                            </span>
                      ...
                      <div style={{ textAlign: "center", background: "#f8fafc", borderRadius: 10, padding: "12px 20px", flexShrink: 0 }}>
                  ...
                  {diag && (
                    <div style={{ background: "linear-gradient(180deg, #ffffff 0%, #f8fafc 100%)", borderRadius: 12, boxShadow: "0 2px 12px rgba(0,0,0,0.3)", padding: 18, marginBottom: 16, border: "1px solid rgba(0,0,0,0.08)" }}>
                      ...
                      <div style={{ marginBottom: 14 }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 8 }}>
                          {[
                            ...
                            <div key={label} style={{ background: "#f8fafc", borderRadius: 8, padding: "10px 12px", border: `1px solid ${dados.cnes === "EXPIRADO" ? "#7f1d1d" : dados.cnes === "A APURAR" ? "#374151" : "#1e3a5f"}` }}>
                          ...
                          <div style={{ background: "#f8fafc", borderRadius: 8, padding: "10px 12px", border: "1px solid #1e3a5f" }}>
                        ...
                        <div style={{ marginBottom: 14 }}>
                          ...
                          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                            {diag.pendencias.map((p, i) => (
                              <div key={i} style={{ background: "#f8fafc", borderRadius: 6, padding: "8px 12px", fontSize: 12, color: p.startsWith("🚨") ? "#fca5a5" : p.startsWith("⚠") ? "#fde68a" : "#94a3b8", borderLeft: `3px solid ${p.startsWith("🚨") ? "#ef4444" : p.startsWith("⚠") ? "#f59e0b" : "#475569"}` }}>
                                {p}
                              </div>
                            ))}
                          </div>
                      ...
                      {/* Observação */}
                      {diag.obs && (
                        <div style={{ background: "#f8fafc", borderRadius: 8, padding: "10px 12px", fontSize: 12, color: "#475569", borderLeft: "3px solid #334155", fontStyle: "italic" }}>
                          {diag.obs}
                        </div>
                      )}
                    </div>
