...
export default function SaudeFamiliaApui() {
  ...
  const ABAS = [
    ...
    { key: "previne",      label: "Previne Brasil",  icon: <AlertTriangle size={15}/> },
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">ESF · ACS · Previne Brasil · Cobertura · PMAQ · FMS Apuí/AM</p>
          </div>
        </div>
        ...
        {aba === "dashboard" && dashRaw && (
          <div className="space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <KPI label="Nota Previne Brasil"   value={`${dashRaw.previne_nota_geral}/10`} color={statusColor(dashRaw.status_previne)} sub={`meta: ${dashRaw.previne_meta_nota}`} />
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { label: "Nota Previne Brasil",      value: dashRaw.previne_nota_geral * 10,   max: 100, color: statusColor(dashRaw.status_previne) },
                  ].map((b) => (
                    <div key={b.label}>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-900 flex flex-col gap-2 justify-center">
                ...
                <p><b>Nota Previne 6,4</b> — abaixo da meta 7,0 impacta no financiamento federal (Piso da APS). Indicador mais crítico: pré-natal com odontológico (38,4% vs meta 60%).</p>
                <p><b>3 UBS sem saúde bucal</b> — gestantes sem acesso odontológico contribuem para o pior indicador Previne e para prematuridade e baixo peso ao nascer.</p>
              </div>
            </div>
          </div>
        )}
        ...
        {aba === "equipes" && Array.isArray(equipes) && (
          <div className="space-y-4">
            <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
              <h3 className="font-semibold text-slate-700 mb-4">Nota Previne por Equipe ESF</h3>
              <ResponsiveContainer width="100%" height={240}>
                <BarChart data={equipes as any[]} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                  ...
                  <Bar dataKey="previne_nota" name="Nota Previne" radius={[3,3,0,0]}>
                ...
                <div key={e.equipe} className="bg-white rounded-xl border border-slate-200 p-3 shadow-sm">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-slate-400">/10 Previne</p>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={historico} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                ...
                <Line yAxisId="s" dataKey="previne_nota"      name="Nota Previne"        stroke={WARN}   strokeWidth={2} dot={{ r: 4 }} strokeDasharray="4 4" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        )}
