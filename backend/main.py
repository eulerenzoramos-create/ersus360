...
from routers.siconfi        import router as siconfi_router
from routers.rreo_anexo12   import router as rreo_anexo12_router
...
from routers.saude_digital_apui import router as saude_digital_apui_router
from routers.fundo_municipal_saude_apui import router as fundo_municipal_saude_apui_router
...
from routers.saude_cardiovascular_apui import router as saude_cardiovascular_apui_router
from routers.saude_renal_apui import router as saude_renal_apui_router
from routers.violencia_acidentes_apui import router as violencia_acidentes_apui_router
...
from routers.doacao_orgaos_apui import router as doacao_orgaos_apui_router
from routers.nutricao_clinica_apui import router as nutricao_clinica_apui_router
from routers.psicologia_aps_apui import router as psicologia_aps_apui_router
...
app.include_router(siconfi_router)
app.include_router(rreo_anexo12_router)
...
app.include_router(agua_saneamento_apui_router)
app.include_router(saude_digital_apui_router)
app.include_router(fundo_municipal_saude_apui_router)
...
app.include_router(saude_cardiovascular_apui_router)
app.include_router(saude_renal_apui_router)
app.include_router(violencia_acidentes_apui_router)
...
app.include_router(doacao_orgaos_apui_router)
app.include_router(nutricao_clinica_apui_router)
app.include_router(psicologia_aps_apui_router)
...
from routers.relatorio_producao_pdf import router as relatorio_producao_pdf_router
...
app.include_router(relatorio_producao_pdf_router)
