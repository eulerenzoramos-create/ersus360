"""Router: /api/monitor-epidem — ERSUS 360 — SINAN dados abertos"""
...
async def dashboard(ano: int = Query(0)):
    ...
    return {"situacao_dado": "oficial_validado" if any_real else "nao_disponivel", "ano": ano, "total_agravos": agravos.get("total_agravos"), "casos_malaria": malaria.get("total_casos"), "casos_dengue": dengue.get("total_casos"), "fonte": "SINAN — DATASUS dados abertos", "verificado_em": _TS()}
