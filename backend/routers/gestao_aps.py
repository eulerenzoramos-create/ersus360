...
async def equipes_esf():
    def _e(cnes, nome, unidade, area, tipo, pop, cob, completa, motivo=None,
           med=None, enf=None, tec=None, acs=7):
        return {
            "cnes": cnes, "nome": nome, "unidade": unidade, "area": area, "tipo": tipo,
            "populacao_cadastrada": pop, "pct_cobertura": cob,
            "completa": completa, "incompleta_motivo": motivo,
            "composicao": {
                "medico":             {"nome": med, "carga_horaria": 40} if med else None,
                "enfermeiro":         {"nome": enf} if enf else None,
                "tecnico_enfermagem": {"nome": tec} if tec else None,
                "acs": acs,
            },
        }

    equipes = [
        _e("2516341","LIBERDADE",    "USF LIBERDADE",     "Urbana",    "eSF",  3_124,91.2,True, None,"Médico LIBERDADE",    "Enf. LIBERDADE",    "Téc. LIBERDADE",    8),
        _e("2516342","KENNEDY",      "USF KENNEDY",       "Urbana",    "eSF",  2_876,87.4,True, None,"Médico KENNEDY",      "Enf. KENNEDY",      "Téc. KENNEDY",      7),
        _e("2516343","JUMA",         "USF JUMA",          "Urbana",    "eSF",  2_743,89.1,True, None,"Médico JUMA",         "Enf. JUMA",         "Téc. JUMA",         7),
        _e("2516344","JK",           "USF JK",            "Urbana",    "eSF",  2_934,88.3,True, None,"Médico JK",           "Enf. JK",           "Téc. JK",           8),
        _e("2516345","CACHOEIRA",    "USF CACHOEIRA",     "Urbana",    "eSF",  2_812,86.9,True, None,"Médico CACHOEIRA",    "Enf. CACHOEIRA",    "Téc. CACHOEIRA",    7),
        _e("2516346","SÃO SEBASTIÃO","USF SÃO SEBASTIÃO", "Urbana",    "eSF",  2_698,84.2,True, None,"Médico SÃO SEBASTIÃO","Enf. SÃO SEBASTIÃO","Téc. SÃO SEBASTIÃO",7),
        _e("2516347","ACARI",        "USF ACARI",         "Urbana",    "eSF",  2_614,82.7,True, None,"Médico ACARI",        "Enf. ACARI",        "Téc. ACARI",        7),
        _e("2516348","TRÊS ESTADOS", "USF TRÊS ESTADOS",  "Urbana",    "eSF",  2_587,71.3,False,"Vaga de médico em aberto desde Fev/2026.",None,"Enf. TRÊS ESTADOS","Téc. TRÊS ESTADOS",7),
        _e("2516349","ESTRADA NOVA", "USF ESTRADA NOVA",  "Ribeirinha","eSFR", 1_842,78.4,True, None,"Médico ESTRADA NOVA", "Enf. ESTRADA NOVA", "Téc. ESTRADA NOVA", 8),
        _e("2516350","ESB — APUÍ",  "UNID. ODONTOLÓGICA","Urbana",    "eSB",  0,    100.0,True, None, None, None, None, 0),
    ]
    return {
        ...
        "populacao_total": sum(e["populacao_cadastrada"] for e in equipes),
        "equipes": equipes,
    }
