...
def _INTERVENCOES():
    return [
        ...
        {"intervencao": "CAPS II (24h) — expansão do CAPS ad",
         ...
         "observacao": "CAPS ad existente: atende transtornos por álcool/drogas. CAPS II: suicídio + depressão + esquizofrenia. Portaria GM/MS 336/2002: CAPS II indicado para municípios > 20.000 habitantes — Apuí (18.732) é elegível. Financiamento MS: R$ 60.000/mês de custeio. Custo municipal: R$ 20.000/mês = R$ 240.000/ano. Implantação: R$ 840.000 (reforma + equipamentos — MS financia 80% = R$ 168.000 municipal). Prazo: 24 meses. Com CAPS II: psiquiatra permanente + 2 psicólogos + leito de acolhimento noturno (evita transferência emergencial a Manaus). Cada internação em Manaus evitada: R$ 42.000"},
    ]
