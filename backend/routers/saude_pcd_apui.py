...
def _DEFICIENCIAS():
    return [
        {"tipo": "Deficiência física (motora)",    "prevalencia_estimada": 620, "cadastradas": 148, "reabilitacao_acesso_pct": 18.4, "status": "critico",  "observacao": "Amputações (diabéticos + garimpo): 12/ano. AVC com sequela motora: 18/ano. Fisioterapeuta: 1 para 24.700 hab. Órteses e próteses: confecção em Manaus com fila de 6-18 meses via TFD. Paciente com AVC sem fisioterapia nas primeiras 72h = sequela definitiva evitável"},
