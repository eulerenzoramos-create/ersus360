...
async def dashboard(ano: int = Query(0)):
    ...
    return {"situacao_dado": "oficial_validado" if any_real else "nao_disponivel", "ano": ano, "agravos_notificados": sum(d.get("total_casos", 0) or 0 for d in sinan), "producao": sia.get("total_procedimentos"), "fonte": "SINAN + SIA — DATASUS dados abertos", "verificado_em": _TS()}
