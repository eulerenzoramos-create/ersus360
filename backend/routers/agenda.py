...
async def listar_eventos():
    return [
        ...
        },
        {
            "situacao_dado": "referencia_municipal",
            "id": 2,
            "titulo": "Prestação de contas Previne Brasil — 1º Quadrimestre/26",
            "tipo": "producao",
            "data": "2026-04-15",
            "status": "pendente",
            "prioridade": "alta",
            "responsavel": "Coordenação APS",
            "descricao": "Encerramento do período de lançamento de produção no SISAB para fins de Previne Brasil. Metas de consulta pré-natal, hipertensão e diabetes.",
            "dias_restantes": 33,
            "urgencia": "proximo",
        },
        {
...
async def proximos_prazos():
    return [
        ...
        },
        {
            "situacao_dado": "referencia_municipal",
            "id": 2,
            "titulo": "Previne Brasil — 1º Quadrimestre/26",
            "data": "2026-04-15",
            "dias_restantes": 33,
            "urgencia": "proximo",
            "tipo": "producao",
