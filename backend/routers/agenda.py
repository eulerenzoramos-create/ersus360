...
_OBRIGACOES = [
    ...
    { "id": 5,  "titulo": "Previne Brasil — Dig. Jul.", "tipo": "producao", "data": "2026-07-10", "status": "concluido", "prioridade": "alta",  "responsavel": "APS",         "descricao": "Prazo para digitação da produção APS no e-SUS PEC — competência Jul/2026." },
