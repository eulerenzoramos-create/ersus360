"""Router: /api/saude-mulher — ERSUS 360 — SINASC+SIA dados abertos"""
...
async def dashboard(ano: int = Query(0)):
    ...
    return {"situacao_dado": "oficial_validado" if any_real else "nao_disponivel", "ano": ano, "nascidos_vivos": sinasc.get("total_nascidos"), "producao_ginecologica": sia.get("total_procedimentos"), "fonte": "SINASC + SIA — DATASUS dados abertos", "verificado_em": _TS()}
