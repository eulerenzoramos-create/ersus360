"""Router: /api/agua-saneamento-apui — ERSUS 360 — SINAN dados abertos"""
...
_NOTA = "SISÁGUA/SNIS pendentes. SINAN como proxy de agravos associados ao saneamento inadequado."
