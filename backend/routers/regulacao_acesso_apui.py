"""Router: /api/regulacao-acesso-apui — ERSUS 360 — SIA+CNES dados abertos"""
...
_NOTA = "SISREG e fila de espera requerem integração específica (pendente). SIA/CNES como proxy."
