...
def _INDICADORES():
    return [
        ...
        {"indicador": "CAPS superlotação",                        "valor": 153.3,"meta": 100.0,"unidade": "% capacidade","status": "critico","observacao": "184 pacientes / capacidade 120. CAPS I inadequado para município de 18.732 hab — necessita CAPS II. CAPS AD inexistente apesar de demanda significativa (38,4% alcool/drogas). Sem leito de crise para observação de 24-72h"},
