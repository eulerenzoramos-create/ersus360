...
def _INDICADORES():
    return [
        ...
        {"indicador": "IIP Aedes aegypti",                 "valor": 4.2,   "meta": 1.0,   "unidade": "%",          "status": "critico", "observacao": "Nível de alerta (1-3,9%) ultrapassado: IIP 4,2% = risco de epidemia de dengue. 284 casos em 2025 com tendência ascendente. Agente de endemias (2) insuficiente para 18.732 hab — meta 1/2000 = 12 agentes necessários"},
