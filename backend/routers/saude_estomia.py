"""Router: /api/saude-estomia — ERSUS 360 — SIA dados abertos"""
...
_NOTA = "Cadastro de ostomizados individual requer sistema local (pendente). SIA como proxy de dispensação."
