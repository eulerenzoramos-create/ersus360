"""Router: /api/medicamentos-alto-custo-apui — ERSUS 360 — SIA dados abertos"""
...
_NOTA = "HORUS/BNAFAR individuais requerem integração (pendente). SIA como proxy de dispensação ambulatorial."
...
async def dispensacao(ano: int = Query(0)): return await dashboard(ano=ano)
