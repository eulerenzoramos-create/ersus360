...
def _INDICADORES():
    return [
        ...
        {"indicador": "Tempo resposta SAMU",              "valor": 38.0, "meta": 15.0, "unidade": "min",     "status": "critico", "observacao": "38 min vs meta 15 min. Causa: 1 UBM para 18.732 habitantes, ramais sem pavimentação, helitransporte indisponível. 4 óbitos em 2025 ocorreram durante transporte (golden hour não cumprida). Parceria helitransporte SAMU+HMM: FIOT-AM tem 1 helicóptero regional — protocolo não formalizado"},
