...
async def folha(competencia: str = Query("2026-07")):
    """Retorna folha importada do Fiorele para a competência solicitada."""
    ...
    return {
        ...
        "nota": (
            "Nenhuma folha importada para esta competência. "
            "Exporte do Fiorele (Menu Folha → Exportar → CSV/TXT) "
            "e faça upload em /api/folha/importar ou pelo botão no ERSUS 360."
        ),
        "fonte": "Fiorele — pendente importação",
        "verificado_em": _TS(),
    }
