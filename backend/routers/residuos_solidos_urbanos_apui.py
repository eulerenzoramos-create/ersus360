"""Router: /api/residuos-solidos-urbanos-apui — ERSUS 360 — SINAN dados abertos"""
...
_NOTA = "SINIS/SNIS RSU pendentes. SINAN como proxy de agravos ambientais associados."
