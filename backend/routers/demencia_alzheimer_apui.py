"""
Router: /api/demencia-alzheimer-apui — ERSUS 360
Demência/Alzheimer via SIH (CID F00-F03) + SIM — DATASUS dados abertos.
"""
...
_NOTA = "Filtro por CID F00-F03 (demências) requer query específica no SIH/SIM (pendente)."
