"""Router: /api/protocolo-clinico — ERSUS 360 — SIA dados abertos"""
...
_NOTA = "Protocolos clínicos locais requerem módulo de gestão (pendente). SIA como proxy de adesão por procedimento."
...
async def protocolos(ano: int = Query(0)): return await dashboard(ano=ano)
