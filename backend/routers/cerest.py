"""
Router: /api/cerest — ERSUS 360
CEREST: saúde do trabalhador via SINAN + SIH — DATASUS dados abertos.
"""
...
_NOTA = "Notificações CEREST de acidente trabalho grave requerem SINAN CEREST regional (pendente)."
