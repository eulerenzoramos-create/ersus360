"""Router: /api/planejamento-orc — ERSUS 360 — SIOPS dados abertos"""
...
async def dashboard(ano: int = Query(0)):
    ...
    return {"situacao_dado": siops.get("situacao_dado"), "ano": ano, "despesa_total_saude": siops.get("despesa_total_saude"), "percentual_saude_receita": pct, "historico": hist.get("historico"), "alertas": alertas, "fonte": "SIOPS — DATASUS dados abertos", "verificado_em": _TS()}
