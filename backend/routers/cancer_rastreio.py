...
async def dashboard(ano: int = Query(0)):
    ...
    return {"situacao_dado": "oficial_validado" if any_real else "nao_disponivel", "ano": ano, "agravos_notificados": sinan.get("total_agravos"), "producao_oncologia": sia.get("total_procedimentos"), "fonte": "SINAN + SIA — DATASUS dados abertos", "verificado_em": _TS()}
