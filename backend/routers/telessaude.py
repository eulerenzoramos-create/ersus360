"""Router: /api/telessaude — ERSUS 360 — CNES dados abertos"""
...
_NOTA = "Teleconsultas individuais requerem plataforma Telessaúde (pendente). CNES como proxy de infraestrutura."
