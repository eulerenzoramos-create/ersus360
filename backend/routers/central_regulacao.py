"""Router: /api/central-regulacao — ERSUS 360 — SIA+CNES dados abertos"""
...
_NOTA = "Central SISREG individual requer integração (pendente). SIA/CNES como proxy de oferta regulada."
