"""Router: /api/farmacovigilancia-apui — ERSUS 360 — SINAN+SIA dados abertos"""
...
_NOTA = "Notificações NOTIVISA/ANVISA requerem integração (pendente). SINAN/SIA como proxy de eventos adversos."
