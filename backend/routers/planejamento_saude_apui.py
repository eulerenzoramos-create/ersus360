...
_IDSUS_COMPONENTES = [
    {"componente": "Atenção Básica",           "nota": 3.8, "media_am": 4.6, "status": "critico",  "observacao": "Abaixo da média estadual em 0,8 pontos. ESF incompleta, absenteísmo 28,4%, rotatividade médica 72,4%. Previne Brasil negativo arrasta a nota. Indicadores Previne: apenas 6/21 metas atingidas"},
...
_INDICADORES = [
    {"indicador": "Previne Brasil — metas atingidas",   "valor": 28.6,  "meta": 80.0,  "unidade": "%",        "status": "critico", "observacao": "6/21 indicadores acima da meta. Cada indicador abaixo da meta gera desconto no repasse federal PAB. Perda estimada 2025: R$ 280k em incentivos não captados. Indicadores Previne são atingíveis: outros municípios de porte similar atingem 60-70% das metas com equipe completa e sem rotatividade"},
