"""Router: /api/residuos-saude-apui — ERSUS 360 — SINAN dados abertos"""
...
_NOTA = "PGRSS/sistema local de GRSS requer integração (pendente). SINAN como proxy de agravos ambientais."
