...
def _CARGOS():
    return [
        ...
        {"categoria": "Fisioterapeuta",             "vagas": 4,  "preenchidas": 1,  "temporarios": 1, "concursados": 0, "salario_R": 4200,  "rotatividade_pct": 100.0,"status": "critico",  "observacao": "75% de vagas descobertas. 1 fisioterapeuta para 18.732 hab. Reabilitação pós-AVC, fratura e amputação: paciente esperando meses sem fisioterapia. AVC sem fisioterapia precoce = sequela definitiva que poderia ser reduzida com reabilitação dentro de 72h"},
