"""Router: /api/pcd-crianca-apui — ERSUS 360 — SIA+CNES dados abertos"""
...
_NOTA = "SIDEF/BPC individuais requerem integração (pendente). SIA/CNES como proxy de atendimento PCD criança."
