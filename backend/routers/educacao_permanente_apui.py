"""Router: /api/educacao-permanente-apui — ERSUS 360 — SIA+CNES dados abertos"""
...
_NOTA = "Atividades EPS individuais requerem sistema local (pendente). SIA/CNES como proxy."
