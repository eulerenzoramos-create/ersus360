"""Router: /api/saude-servidor — ERSUS 360 — CNES dados abertos"""
...
_NOTA = "PCMSO/CAT individuais requerem sistema de RH municipal (pendente). CNES como proxy de infraestrutura."
